...
=======
- [x] Define the data-access foundation with Prisma
- [x] Bootstrap the NestJS API
- [ ] Implement the authentication flow
- [ ] Finalize the authorization model
- [ ] Build the first production-ready business modules
>>>>>>> Stashed changes
